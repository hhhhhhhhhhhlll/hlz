...
/* harmony default export */ var tags = ({
  ...
  watch: {
    $route: function $route(newValue, oldValue) {
      ...
      if (this.tagsList && this.tagsList.length > 0) {
        //只显示一个批次流程追溯表tag
        var obj = this.tagsList.filter(function (res) {
          return res.path.indexOf("/flowTable") != "-1";
        });
        if (obj && obj.length > 1) {
          this.tagsList.map(function (res, index) {
            if (res.path.indexOf("/flowTable") != "-1") {
              _this.handleCloseTags(index);
              //刷新批次流程追溯表界面
              bus["a" /* default */].$emit('refreshFlowTable', 'true');
            }
          });
        }
      }
  ...
  methods: {
    ...
    setTags: function setTags(route) {
      ...
      bus["a" /* default */].$emit('tags', this.tagsList);
    },
    ...
    //关闭标签
    handleCloseTags: function handleCloseTags(index) {
    ...
    handleCloseOther: function handleCloseOther() {
      ...
      var curItem = this.tagsList.filter(function (item) {
        return item.path === _this3.$route.fullPath;
      });
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib!./node_modules/vue-loader/lib/selector.js?type=script&index=0!./src/components/tags/tags.vue
//
//
//
//
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/template-compiler?{"id":"data-v-17e5c149","hasScoped":false,"transformToRequire":{"video":["src","poster"],"source":"src","img":"src","image":"xlink:href"},"buble":{"transforms":{}}}!./node_modules/vue-loader/lib/selector.js?type=template&index=0!./src/components/tags/tags.vue
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return (_vm.showTags)?_c('div',{staticClass:"tags"},[_c('ul',_vm._l((_vm.tagsList),function(item,index){return _c('li',{key:index,staticClass:"tags-li",class:{ 'active': _vm.isActive(item.path) }},[_c('router-link',{staticClass:"tags-li-title",attrs:{"to":item.path}},[_vm._v(" "+_vm._s(item.title)+" ")]),_vm._v(" "),_c('span',{staticClass:"tags-li-icon",on:{"click":function($event){return _vm.handleCloseTags(index)}}},[_c('i',{staticClass:"el-icon-close"})])],1)}),0),_vm._v(" "),_c('div',{staticClass:"tags-close-box"},[_c('el-dropdown',{on:{"command":_vm.handleTags}},[_c('el-button',{attrs:{"size":"mini","type":"primary"}},[_vm._v(" 标签选项"),_c('i',{staticClass:"el-icon-arrow-down el-icon--right"})]),_vm._v(" "),_c('el-dropdown-menu',{attrs:{"slot":"dropdown","size":"small"},slot:"dropdown"},[_c('el-dropdown-item',{attrs:{"command":"other"}},[_vm._v("关闭其他")]),_vm._v(" "),_c('el-dropdown-item',{attrs:{"command":"all"}},[_vm._v("关闭所有")])],1)],1)],1)]):_vm._e()}
var staticRenderFns = []
var esExports = { render: render, staticRenderFns: staticRenderFns }
/* harmony default export */ var components_tags_tags = (esExports);
// CONCATENATED MODULE: ./src/components/tags/tags.vue
function injectStyle (ssrContext) {
  __webpack_require__("0r4b")
}
...
/* harmony default export */ var src_components_tags_tags = __webpack_exports__["default"] = (Component.exports);
...
//# sourceMappingURL=20.ebb05d0a1b5b33d5623c.js.map